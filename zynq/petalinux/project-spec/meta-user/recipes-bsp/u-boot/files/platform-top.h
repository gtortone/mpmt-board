...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"initrd_load_address=0x5000000\0" \
	...
	"flash_bootbin=tftpboot 0x09000000 mpmt/zynq/BOOT.BIN && sf probe 0 && sf erase 0 0x1000000 && sf write 0x09000000 0 ${filesize}\0" \
	"verify_bootbin=tftpboot 0x09000000 mpmt/zynq/BOOT.BIN && sf probe 0 && sf read 0xA000000 0 ${filesize} && cmp.b 0x09000000 0xA000000 ${filesize}\0"
